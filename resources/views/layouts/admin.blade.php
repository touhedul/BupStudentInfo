...
<header id="main-header">
    <nav class="navbar navbar-expand-sm navbar-light  " style="background-color:#FFFFFF;">
        <div class="container">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link display-6" href="#"></a>
                </li>
                <li class="nav-item">
        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.student')}}">Student</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.faculty')}}">Faculty</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.assign.course')}}">Assign courses</a>
                    </li>
